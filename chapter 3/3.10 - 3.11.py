# 3.10
places = ["London", "Tokyo", "Lagos", "Manila", "Rabat", "New york", "Abuja"]
places.pop()
...
print(f"{sorted(places)} This list has been sorted alphabetically")
...
places.reverse()
print(f"{places} The list has been reverted to it original form")

places.sort()
print(f"{places} The list has been permanently sorted alphabetically")

places.sort(reverse=True)
print(f"{places} This is a permanently sorted and reversed list")

print(
    f"This list contain {len(places)} places, places "
    f"like; \n{places[1]}, \n{places[4]}, \n{places[6]} and so on"
)
